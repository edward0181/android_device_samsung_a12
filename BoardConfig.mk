...
TARGET_ODMIMAGES_USE_EXT4 := true
...
#BOARD_DTBO_CFG               := $(DEVICE_PATH)/kernel/mt6765.cfg
...
#TARGET_KERNEL_ADDITIONAL_FLAGS := LD=ld.lld AR=llvm-ar NM=llvm-nm OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump STRIP=llvm-strip AS=llvm-as
#TARGET_KERNEL_ADDITIONAL_FLAGS += HOSTCFLAGS="-fuse-ld=lld -Wno-unused-command-line-argument"
#TARGET_KERNEL_CLANG_PATH := $(shell pwd)/prebuilts/clang/host/linux-x86/clang-proton  
#TARGET_KERNEL_CLANG_PATH := home/edward/toolchains/proton-clang
#TARGET_KERNEL_CLANG_PROTON := true
#TARGET_KERNEL_CROSS_COMPILE_PREFIX := aarch64-linux-androidkernel-

BOARD_CUSTOM_BOOTIMG := true
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/a12/kernel/mkbootimg.mk
...
# TWRP Configuration
TW_DEVICE_VERSION := Edward0181-DEV-RC3
